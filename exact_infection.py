...
def exact_infection(graph, initial, num, threshold):
    """
    Infects exactly num of users given an initial user. This is a
    ...
    # returns only if the number of infected people is exactly the parameter
    if len(infected) != num:
        return None
